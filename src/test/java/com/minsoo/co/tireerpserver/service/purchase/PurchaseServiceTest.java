...
//
//        // THEN
//        assertThat(purchaseService.findAllAsResponses(null, null).size()).isEqualTo(3);
//        assertThat(purchaseService.findAllAsResponses(LocalDate.of(2021, 2, 28), null).size()).isEqualTo(2);
//        assertThat(purchaseService.findAllAsResponses(LocalDate.of(2021, 3, 1), null).size()).isEqualTo(1);
//        assertThat(purchaseService.findAllAsResponses(null, LocalDate.of(2021, 2, 28)).size()).isEqualTo(2);
//        assertThat(purchaseService.findAllAsResponses(LocalDate.of(2021, 2, 27),
...
//        assertThat(purchaseService.findAllAsResponses(null, null).size()).isEqualTo(1);
//        clear();
//
//        // WHEN
