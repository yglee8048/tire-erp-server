...
public class ApiResponse<T> {
    ...
    public static ResponseEntity<ApiResponse<Void>> CREATED(URI uri) {
    ...
    public static ResponseEntity<ApiResponse<Void>> error(HttpStatus status, String error, String message, String detail) {
        return ResponseEntity
                .status(status)
