...
public class BusinessInfoDTO {
    ...
    @Schema(description = "사업자 번호", example = "107-20-59931")
    private String businessNumber;

    @Schema(description = "상호", example = "피렐리")
    private String businessName;

    @Schema(description = "업종", example = "자동차 및 부품 판매업")
    private String businessType;

    @Schema(description = "주소")
    private AddressDTO address;

    @Schema(description = "팩스", example = "02-709-5089")
    private String fax;

    @Schema(description = "이메일 주소", example = "sample@pirelli.com")
    ...
    @Schema(description = "담당자", example = "김철수")
