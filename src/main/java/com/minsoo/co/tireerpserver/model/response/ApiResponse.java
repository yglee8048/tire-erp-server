...
public class ApiResponse<T> {
    ...
    public static final ApiResponse<String> OK = new ApiResponse<>("요청이 성공하였습니다.");

    public static <T> ApiResponse<T> OK(T data) {
        return new ApiResponse<>("요청이 성공하였습니다.", data);
    }

    public static ResponseEntity<ApiResponse<String>> CREATED(URI uri) {
